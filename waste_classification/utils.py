...
#     final_images = {k: v for k, v in new_image_categories.items()
#                     if len(v) <= 1}
#     return final_images
...
#     image_df = id_category_df.merge(
#         id_filename_df, left_index=True, right_index=True)
#     image_df.rename(columns={'0_x': 'category',
#                     '0_y': 'filename'}, inplace=True)
